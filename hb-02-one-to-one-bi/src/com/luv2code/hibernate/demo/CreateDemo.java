...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Instructor instructor = new Instructor("Bhargavi","Prajapati","bhargavi.p4856@gmail.com");
			
			InstructorDetail instructorDetail = new InstructorDetail("www.google.com/youtube/bhargavi","bhargavi TV");
