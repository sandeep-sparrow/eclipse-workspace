...
<%-- 	<jsp:param value="" name=""/> --%>
		...
		<section id="products" class="section">
			<div class="container">
				...
				<p>
					H+ Sport is <em>dedicated to creating</em> echo-friendly,
				...
				%>
				<span id="size">Items to cart: 0</span>
				<% 
					}
				%>
			</div>
			
			<!-- Here we will use the JSP scriplets and JSP Expression tags for processing all the products fetched from DB -->
